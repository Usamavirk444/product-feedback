<?php $__env->startSection('body'); ?>
    <div class="container p-5">
        <h1 class="p-4">Feedback List</h1>
            ...
            <?php echo $__env->make('feedback.filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <table class="table p-5">
            ...
            <tbody>
                <?php $__currentLoopData = $feedbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feedback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><a href="<?php echo e(route('feedback.show', $feedback)); ?>"><?php echo e($feedback->title); ?></a></td>
                        <td><?php echo e($feedback->category); ?></td>
                        <td><?php echo e($feedback->votes()->count()); ?></td>
                        <td><?php echo e($feedback->user->name); ?></td>
                        <td class="d-flex justify-content-between align-items-center p-3">
                            
                            <form method="post" action="<?php echo e(route('votes.update', $feedback->id)); ?>" class="<?php echo e(isset($userVotes[$feedback->id]) && $userVotes[$feedback->id] === 1 ? 'opacity-25' : ''); ?>">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\product-feedback\resources\views/feedback/index.blade.php ENDPATH**/ ?>